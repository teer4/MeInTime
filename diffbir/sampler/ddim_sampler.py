...
#输出sigmas, alphas, alphas_prev所有ddim_timesteps的数组，长度都是num_ddim_timesteps
#alphacums数组长度是 num_ddpm_timesteps，[1.0, 0.9999, 0.9997, ..., 0.1]
def make_ddim_sampling_parameters(
    ...
    alphas_prev = np.asarray([alphacums[0]] + alphacums[ddim_timesteps[:-1]].tolist())    #确保alphas[i]和alphas_pre[i]序列一一对应
