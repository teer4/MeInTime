...
if __name__ == "__main__":
    ...
    net.eval()
    image = Image.open('inputs/Alpacino/ref3.png')
    face_parsing = evaluate(image, net)
    mask = evaluate(image, net, mode='mask')
    #cv2.imwrite('inputs/Dakota/ref1_add.jpg', face_parsing)
    cv2.imwrite('inputs/Alpacino/ref3_mask.png', (mask * 255).astype('uint8'))
