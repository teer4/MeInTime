...
DEFAULT_SRC_PROMPT = ("photo of a person")
...
def parse_args() -> Namespace:
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Optional prompt list file (identity<TAB>prompt) used for batch identity-aware prompts."
    )
    parser.add_argument(
        "--neg_prompt",
        type=str,
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="Path to folder that contains your reference images.",
    )
    parser.add_argument(
